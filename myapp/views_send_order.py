...
def purchaseSend(request):
    ...
    return render(request, 'order/purchaseOrdSend.html', {
        'form': form,
        'requests': requests,
...
@login_required
def purchase_send_detail(request, registered_no):
    ...
    html = render(request, 'order/partials/purchase_send_detail.html', {
